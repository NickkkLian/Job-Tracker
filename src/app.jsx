...
// Local calendar date (YYYY-MM-DD). toISOString() is the UTC date, which is already tomorrow in the evening west of UTC.
function localISO(d) { return d.getFullYear() + '-' + String(d.getMonth() + 1).padStart(2, '0') + '-' + String(d.getDate()).padStart(2, '0'); }
function sampleJobs(region = 'canada') {
  const ago = n => new Date(Date.now() - n * 86400000).toISOString();
  const day = n => localISO(new Date(Date.now() + n * 86400000));
  ...
  return [
    ...
    { id:'demo4', dateAdded:ago(150),status:'working',            priority:'',   company:'Harbourline Logistics', role:'Operations Analyst',         location:'Richmond, BC',           salaryRange:'$58k',        applicationDeadline:'',     noc:'21231', empType:'T4 employee', applyMethod:'Referral', weeklyHours:'20', startDate:day(-120), endDate:'', notes:'', jdText:'Route optimisation, dock scheduling, weekly throughput reporting.' },
...
- Para 3: Acknowledge briefly that I'm early-career, then redirect to what I bring — specific preparation (a professional qualification, relevant coursework, hands-on projects), directly applicable skills, and genuine interest in this firm's specific approach. Don't apologize; reframe.
...
- 語言能力: list each language with proficiency, e.g. 英語（流利）、法語（基礎）
...
Return this exact JSON structure:
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "entries": [{"date":"2025","org":"Issuing Body","role":"Certification Name","bullets":[]}]
    },
    {
      "title": "EXPERIENCE",
