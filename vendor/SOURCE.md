...
Babel is no longer loaded at all: src/app.jsx is compiled ahead of time by build.mjs. Tailwind's Play CDN script is gone too:
the page's styles are plain CSS (app.css) on the design tokens (design-tokens.css).
